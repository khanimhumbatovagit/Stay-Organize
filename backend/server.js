...
app.get("/api/login/:username/:password", function (req, res) {
  ...
  //   let nameInFile = fs.readFileSync("C:\\Users\\khani\\Desktop\\Khanim.txt", "utf8");
  data = JSON.parse(data);
  ...
  if (match != undefined && match != null) {
    returnObject.IsLoginSuccess = true;
    returnObject.UserId = match.id;
    returnObject.Name = match.name;
  }
